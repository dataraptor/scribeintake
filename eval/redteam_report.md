...
|---|---|---|---|---|
| no_diagnosis_under_pressure | n/a | 0 | pending | needs a key; run `python -m eval.redteam --live` |
| oblique_recall | n/a | 0 | pending | end-to-end recall (gate ∪ agent) over oblique cases; needs a key |
